...
<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	<div class="container">
		...
		<div class="navbar-header ">
			...
			<a class="" href="<?=$us_url_root?>"><img class="img-responsive logo" src="<?=$us_url_root?>users/images/logo.png" alt="" /></a>
		</div>
		<div class="collapse navbar-collapse navbar-top-menu-collapse navbar-right">
			<ul class="nav navbar-nav ">
				<?php if($user->isLoggedIn()){ //anyone is logged in?>
					<li><a href="<?=$us_url_root?>users/user_settings.php"><i class="fa fa-fw fa-user"></i> <?php echo ucfirst($user->data()->username);?></a></li> <!-- Common for Hamburger and Regular menus link -->
					<li class="hidden-sm hidden-md hidden-lg"><a href="<?=$us_url_root?>"><i class="fa fa-fw"></i> My Donations</a></li> <!-- Hamburger menu link -->
					...
					<li class="dropdown hidden-xs"><a class="dropdown-toggle" href="#" data-toggle="dropdown"><i class="fa fa-fw fa-cog"></i><b class="caret"></b></a> <!-- regular user menu -->
						<ul class="dropdown-menu"> <!-- open tag for User dropdown menu -->
							<li><a href="<?=$us_url_root?>"><i class="fa fa-fw"></i> My Donations</a></li> <!-- regular user menu link -->
							<li><a href="<?=$us_url_root?>users/user_settings.php"><i class="fa fa-fw fa-user"></i> Account</a></li> <!-- regular user menu link -->
